/*
 * package com.people10.assignment.AssignmentPeople10.util; import
 * java.util.Properties;
 * 
 * import org.hibernate.SessionFactory; import
 * org.hibernate.boot.registry.StandardServiceRegistryBuilder; import
 * org.hibernate.cfg.Configuration; import org.hibernate.cfg.Environment; import
 ...
 * new Properties(); settings.put(Environment.DRIVER,
 * "com.mysql.cj.jdbc.Driver"); settings.put(Environment.URL,
 * "jdbc:mysql://localhost:3306/HotelDb"); settings.put(Environment.USER,
 ...
 * configuration.addAnnotatedClass(Customer.class); ServiceRegistry
